...
class MruVObjectModelsService(object):
    """The MruV objects service provides procedures for game object models.
    """

    @staticmethod
    def CreateObjectModel(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/mruv.objects.MruVObjectModelsService/CreateObjectModel',
            objects_dot_models__pb2.CreateObjectModelRequest.SerializeToString,
            objects_dot_models__pb2.CreateObjectModelResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def GetObjectModel(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/mruv.objects.MruVObjectModelsService/GetObjectModel',
            objects_dot_models__pb2.GetObjectModelRequest.SerializeToString,
            objects_dot_models__pb2.GetObjectModelResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def UpdateObjectModel(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/mruv.objects.MruVObjectModelsService/UpdateObjectModel',
            objects_dot_models__pb2.UpdateObjectModelRequest.SerializeToString,
            objects_dot_models__pb2.UpdateObjectModelResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def DeleteObjectModel(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/mruv.objects.MruVObjectModelsService/DeleteObjectModel',
            objects_dot_models__pb2.DeleteObjectModelRequest.SerializeToString,
            objects_dot_models__pb2.DeleteObjectModelResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def FetchAllModels(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/mruv.objects.MruVObjectModelsService/FetchAllModels',
            objects_dot_models__pb2.FetchAllModelsRequest.SerializeToString,
            objects_dot_models__pb2.FetchAllModelsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
